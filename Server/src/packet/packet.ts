    ...
    export class C_CaughtReport extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("caughtPlayerId" in data && data.caughtPlayerId != undefined) {
                    this.caughtPlayerId = data.caughtPlayerId;
                }
            }
        }
        get playerId() {
        ...
        set caughtPlayerId(value: number) {
            pb_1.Message.setField(this, 2, value);
        }
        static fromObject(data: {
            playerId?: number;
            ...
            if (data.caughtPlayerId != null) {
                message.caughtPlayerId = data.caughtPlayerId;
            }
            return message;
        }
        toObject() {
            ...
            if (this.caughtPlayerId != null) {
                data.caughtPlayerId = this.caughtPlayerId;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.playerId != 0)
                writer.writeInt32(1, this.playerId);
            if (this.caughtPlayerId != 0)
                writer.writeInt32(2, this.caughtPlayerId);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        message.caughtPlayerId = reader.readInt32();
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class S_CaughtConfirm extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("catchPlayerId" in data && data.catchPlayerId != undefined) {
                    this.catchPlayerId = data.catchPlayerId;
                }
            }
        }
        get playerId() {
        ...
        set catchPlayerId(value: number) {
            pb_1.Message.setField(this, 2, value);
        }
        static fromObject(data: {
            playerId?: number;
            ...
            if (data.catchPlayerId != null) {
                message.catchPlayerId = data.catchPlayerId;
            }
            return message;
        }
        toObject() {
            ...
            if (this.catchPlayerId != null) {
                data.catchPlayerId = this.catchPlayerId;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.playerId != 0)
                writer.writeInt32(1, this.playerId);
            if (this.catchPlayerId != 0)
                writer.writeInt32(2, this.catchPlayerId);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        message.catchPlayerId = reader.readInt32();
                        break;
                    default: reader.skipField();
                }
            }
